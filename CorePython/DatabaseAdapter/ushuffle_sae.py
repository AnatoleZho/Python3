...
from ushuffle import DBNAME, NAMELEN, randName, FIELDS, tformat, cformat, setup

DSNs = {'mysql': 'mysql://root@localhost/%s' % DBNAME, 'sqlite': 'sqlite:///:menory',}
...
def main():
	...
	fr, to, num = orm.updata()
	printf('\t(%d usrs moved) from (%d) to (%d)' % (num, fr, to))
	orm.dbDump()
